...
SNIPPETS = {
    ...
    "verify-digest":    ("crates/adapters/delonix-oci/src/registry.rs", 979, 1002, "rust"),
    "safe-bind-target": ("crates/adapters/delonix-linux/src/lib.rs", 1214, 1242, "rust"),
    "exit-codes":       ("crates/foundation/delonix-model/src/exitcode.rs", 142, 163, "rust"),
    "store-update":     ("crates/adapters/delonix-state/src/store.rs", 538, 563, "rust"),
    "write-atomic":     ("crates/adapters/delonix-state/src/store.rs", 182, 229, "rust"),
    "arch-layers":      ("scripts/arch_fitness.py", 51, 87, "python"),
    "vm-backend":       ("crates/adapters/delonix-vm/src/lib.rs", 814, 850, "rust"),
    "cri-cgroup":       ("crates/interfaces/delonix-cri/src/runtime_svc.rs", 535, 560, "rust"),
    "reconcile-plan":   ("crates/contexts/delonix-stack/src/reconcile.rs", 345, 389, "rust"),
    "reconcile-doc":    ("crates/contexts/delonix-stack/src/reconcile.rs", 1, 47, "rust"),
}

# excertos que terminam a meio de um bloco: acrescenta-se uma reticência visível
TRUNCATED = {"reconcile-plan", "vm-backend"}
